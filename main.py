...
payroll.title("Employee Payroll Management")
...
lblTitle = Label(Tops, font=('arial', 50, 'bold'), text="Employee Payroll Management System", fg="red", bd=10, anchor="w")
...
txtEmployeeName = Entry(InsideLF, font=('arial', 12, 'bold'), bd=20, width=54, bg="gray", justify="left", textvariable = EmployeeName)
...
txtAddress = Entry(InsideLF, font=('arial', 12, 'bold'), bd=20, width=54, bg="gray", justify="left", textvariable = Address)
...
txtReference = Entry(InsideLF, font=('arial', 12, 'bold'), bd=20, width=54, bg="gray", justify="left", textvariable = Reference)
...
txtEmployerName = Entry(InsideLF, font=('arial', 12, 'bold'), bd=20, width=54, bg="gray", justify="left", textvariable = EmployerName)
...
txtCity = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="right", textvariable = City)
...
txtBasic = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="right", textvariable = Basic)
...
txtOverTime = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="right", textvariable = OverTime)
...
lblGrossPay = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="right", textvariable = GrossPay)
...
lblNetPay = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="right", textvariable = NetPay)
...
txtTax = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="right", textvariable = Tax)
...
txtPension = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="right", textvariable = Pension)
txtPension.grid(row=1, column=1)

lblStudenLoan = Label(InsideLFR, font=('arial', 12, 'bold'), text="StudenLoan", fg="black", bd=10, anchor="w")
lblStudenLoan.grid(row=2, column=0)
txtStudenLoan = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="right", textvariable = StudenLoan)
txtStudenLoan.grid(row=2, column=1)

lblNIPavment = Label(InsideLFR, font=('arial', 12, 'bold'), text="NI Pavment", fg="black", bd=10, anchor="w")
lblNIPavment.grid(row=3, column=0)
txtNIPavment = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="right", textvariable = NIPayment)
...
txtDeducations = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="right", textvariable = Deducations)
...
txtPostCode = Entry(InsideRF, font=('arial', 12, 'bold'), bd=10, width=50, bg="gray", justify="right", textvariable = PostCode)
...
txtGender = Entry(InsideRF, font=('arial', 12, 'bold'), bd=10, width=50, bg="gray", justify="right", textvariable = Gender)
...
txtPayDate = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="left", textvariable = PayDate)
...
txtTaxPeriod = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="left", textvariable = TaxPeriod)
...
txtNINumber = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="left", textvariable = NINumber)
...
txtNICode = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="left", textvariable = NICode)
...
txtTaxablePay  = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="left", textvariable = TaxablePay)
...
txtPensionablePay = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="gray", justify="left", textvariable = PensionablePay)
